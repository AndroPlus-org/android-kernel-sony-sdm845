...
# Paths
KERNEL_DIR=`pwd`
TOOLS_DIR=/mnt/ssd/home/android/tama/tools
...
function make_kernel {
		echo
		make CONFIG_BUILD_ARM64_DT_OVERLAY=y O=./out $DEFCONFIG
		make $THREAD CONFIG_BUILD_ARM64_DT_OVERLAY=y O=./out
...
export DTC_EXT=${TOOLS_DIR}/dtc
export DTC_OVERLAY_TEST_EXT=${TOOLS_DIR}/ufdt_apply_overlay
